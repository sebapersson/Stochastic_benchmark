...
function plot_benchmarks(model; importer = "SBMLImporter")
...
plot_benchmarks("multistate"; importer = "ReactionNetworkImporters")
plot_benchmarks("multisite2"; importer = "ReactionNetworkImporters")
plot_benchmarks("egfr_net"; importer = "ReactionNetworkImporters")
plot_benchmarks("BCR"; importer = "ReactionNetworkImporters")
plot_benchmarks("fceri_gamma2"; importer = "ReactionNetworkImporters")
