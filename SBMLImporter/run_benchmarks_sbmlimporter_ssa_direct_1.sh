...
#SBATCH -o ../Results/SBMLImporter/Logs/run_benchmarks_sbmlimporter_ssa_direct_1.log
#SBATCH -N 1  
#SBATCH --ntasks=1  
...
time ${run_julia} --threads $JULIA_THREADS_TO_USE sbmlimporter_make_benchmark.jl multisite2 Direct 1 4 7
