...
#SBATCH -o ../Results/SBMLImporter/Logs/run_benchmarks_sbmlimporter_ssa_sortingdirect.log
#SBATCH -N 1  
#SBATCH --ntasks=1  
...
time ${run_julia} --threads $JULIA_THREADS_TO_USE sbmlimporter_make_benchmark.jl multisite2 SortingDirect 1 5 9
...
time ${run_julia} --threads $JULIA_THREADS_TO_USE sbmlimporter_make_benchmark.jl BCR SortingDirect 3.398 5.01 3
