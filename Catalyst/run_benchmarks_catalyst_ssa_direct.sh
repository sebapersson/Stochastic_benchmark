...
time ${run_julia} --threads $JULIA_THREADS_TO_USE catalyst_make_benchmark.jl multistate Direct 1 5 9

echo "Starts benchmark runs on the multisite2 model."
time ${run_julia} --threads $JULIA_THREADS_TO_USE catalyst_make_benchmark.jl multisite2 Direct 1 5 9
