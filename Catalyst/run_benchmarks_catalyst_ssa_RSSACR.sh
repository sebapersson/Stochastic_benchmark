...
#SBATCH -o ../Results/Catalyst/Logs/run_benchmarks_catalyst_ssa_RSSACR.log
#SBATCH -N 1  
#SBATCH --ntasks=1  
...
time ${run_julia} --threads $JULIA_THREADS_TO_USE catalyst_make_benchmark.jl BCR RSSACR 3.398 5.01 3

echo "Starts benchmark runs on the fceri_gamma2 model."
time ${run_julia} --threads $JULIA_THREADS_TO_USE catalyst_make_benchmark.jl fceri_gamma2 RSSACR 1 3 7
